...
function Terms() {
  ...
  const brand = 'Locals App';
  const email = 'locals.app@gmail.com';
  ...
  <div className='terms-inner'>
    ...
    <p>Last updated November 14, 2020</p>
        ...
        <p>
            ...
            behalf of an entity (“you”) and {brand} ("Company", “we”, “us”, or “our”), concerning your access to
            and use of the {brand} application as well as any other media form, media channel, mobile website or
            ...
            continued use of the App after the date such revised Terms of Use are posted.
            <br></br><br></br>
        ...
        <p>
            ...
            <br></br><br></br>
            Provided that you are eligible to use the App, you are granted a limited license to access and use
            the App and to download or print a copy of any portion of the Content to which you have properly
        ...
        <p>
            You may be required to register with the App. You agree to keep your password confidential and will
        ...
        <p>
            ...
            <br></br>
            1. Systematically retrieve data or other content from the App to create or compile, directly or
            ...
            <br></br>
            14. Upload or transmit (or attempt to upload or to transmit) any material that acts as a passive or
            ...
            <br></br>
            15. Interfere with, disrupt, or create an undue burden on the App or the networks or services
            ...
            <br></br>
            21. Use a buying agent or purchasing agent to make purchases on the App.
            <br></br>
            22. Make any unauthorized use of the App, including collecting usernames and/or email addresses of
            users by electronic or other means for the purpose of sending unsolicited email, or creating user
            accounts by automated means or under false pretenses.
            <br></br>
            23. Use the App as part of any effort to compete with us or otherwise use the App and/or the Content
        ...
        <p>
            The App may contain (or you may be sent via the App) links to other websites ("Third-Party
        ...
        <p>
            ...
            You irrevocably consent that the courts of Canada shall have exclusive jurisdiction to resolve
        ...
        <h3>CORRECTIONS</h3>
        <p>
            There may be information in the App that contains typographical errors, inaccuracies, or omissions,
        ...
        <p>
            ...
            LOST PROFIT, LOST REVENUE, LOSS OF DATA, OR OTHER DAMAGES ARISING FROM YOUR USE OF THE APP, EVEN IF
            ...
            ACTION, WILL AT ALL TIMES BE LIMITED TO THE AMOUNT PAID, IF ANY, BY YOU TO US DURING THE ONE (1)
        ...
        <h3>INDENIFICATION</h3>
        <p>
            You agree to defend, and hold us harmless, including our subsidiaries, affiliates, and all of our
            ...
            or arising out of: (1) use of the App; (2) breach of these Terms of Use; (3) any breach of your
            representations and warranties set forth in these Terms of Use; (4) your violation of the rights of
            a third party, including but not limited to intellectual property rights; or (5) any overt harmful
            act toward any other user of the App with whom you connected via the Site. Notwithstanding the
        ...
        <p>
            ...
            performance of the application, as well as data relating to your use of the App. Although we perform
            regular routine backups of data, you are solely responsible for all data that you transmit or that
            relates to any activity you have undertaken using the App. You agree that we shall have no liability
        ...
        <h3>CONTACT US</h3>
        <p>
            In order to resolve a complaint regarding {brand} or to receive further information regarding use of
        ...
        <p>
            Thank you for choosing to be part of our community at {brand} (“Company”, “we”, “us”, or “our”). We
            ...
            seriously. In this privacy policy, we seek to explain to you in the clearest way possible what
            ...
            Policy that you do not agree with, please discontinue use of our services.
            <br></br>
            This Privacy Policy applies to all information collected through our and/or any related services,
        ...
        <p>
            ...
            usage information, such as device characteristics, operating system, language preferences, referring
            URLs, device name, information about how and when you use our services and other technical
            information. This information is primarily needed to maintain the security and operation of our
            system, and for our internal analytics and reporting purposes.
            <br></br>
            We also collect information through cookies and similar technologies to provide our users with a
            customizable experience. Unlike most providers your cookies are only stored for your active session
            and will be permanently deleted upon signing out. By using our App and services you agree to our
            cookie collection. If you disagree with this policy please stop using our App and services.
            <br></br>
            ...
            process, such as in response to a court order or a subpoena (including in response to public
            ...
            litigation in which we are involved. More specifically, we may need to process your data or share
            ...
            products, services or promotions. This information includes analytical data only, no private
            information will ever be shared.
            <br></br>
            Other Users. When you share personal information or otherwise interact with public areas of the App,
            such personal information may be viewed by all users and may be publicly distributed outside the in
            perpetuity. If you interact with other users of our and register through a social network (such as
            Facebook), your contacts on the social network will see your name, profile photo, and descriptions
        ...
        <p>
            ...
            necessary measures to protect your personal information in accordance with this privacy policy and
            applicable law.
        </p>
        ...
        <p>
            ...
            tax, accounting or other legal requirements). No purpose in this policy will require us keeping your
            personal information for longer than 1 year after your account has been terminated.
            <br></br>
